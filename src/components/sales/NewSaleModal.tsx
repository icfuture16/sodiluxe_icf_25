...
export default function NewSaleModal({ isOpen, onClose, storeId, storeName }: NewSaleModalProps) {
  ...
  const handleSubmit = async () => {
    ...
    // Vérifier que le montant total est payé
    ...
    try {
      ...
      // Créer une version simplifiée des paiements pour Appwrite
      // Nous n'utilisons plus paymentSplits qui causait l'erreur
      // mais nous gardons la même structure de données dans le code
