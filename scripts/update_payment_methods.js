...
(async () => {
    console.log('🔄 Mise à jour de l\'attribut paymentMethod...');
    ...
    // 4. Créer un nouvel attribut avec plus de valeurs possibles
    console.log('🔄 Création du nouvel attribut paymentMethod avec valeurs étendues...');
    
    // Liste étendue des méthodes de paiement
    ...
    if (success) {
        ...
        console.log('🎉 La collection sales est maintenant prête à être utilisée avec des méthodes de paiement étendues');
    } else {
